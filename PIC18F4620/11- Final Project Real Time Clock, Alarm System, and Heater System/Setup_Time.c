    ...
    {     
        if (check_for_button_input() == 1)
        {
             ...
             if ((found == Prev) || (found == Next) || (found == Ch_Minus) || (found == Ch_Plus) || (found == Minus) || (found == Plus))
             {
                ...
                if (found == Ch_Plus) Do_Save_New_Time();                  // add code here to check if 'Ch_Plus' then use Do_Save_New_Time();
                if (found == Ch_Minus) Exit_Time_Setup();                  // add code here to check if 'Ch_Minus' Exit_Time_Setup();          
...
{   
    switch (Select_Field)               	     	// Decrement the proper field
    {
        ...
        case 2:                                   //decrement seconds
            if (setup_second == 0) setup_second = 59;
            else --setup_second;
            break;
                                
        case 3:                                   //decrement month
...
//=========================== Initilize the setup Time screen ==================
...
{
    // Update setup_time string with the latest time values
    ...
    // Update setup_date string with the latest date values
